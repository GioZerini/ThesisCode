...
from acds.benchmarks import get_libras_data
...
parser.add_argument(
    "--dt", type=float, default=0.3, help="step size <dt> of the coRNN"
)
parser.add_argument(
...
if args.trials > 1:
    ...
    train_loader, valid_loader, test_loader = get_libras_data(
...
if args.modelname == "trainedpron":
    f = open(os.path.join(args.resultroot, f"TrainedLibras_log_{args.modelname}{args.topology}{args.resultsuffix}.txt"), "a")
