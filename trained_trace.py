...
if args.trials > 1:
    ...
    train_loader, valid_loader, test_loader = get_trace_data(
...
if args.modelname == "trainedpron":
    f = open(os.path.join(args.resultroot, f"TrainedTrace_log_{args.modelname}{args.topology}{args.resultsuffix}.txt"), "a")
