...
parser.add_argument('--modelname', type=str, default="trainedpron", choices=["trainedpron"],
...
if args.trials > 1:
    ...
    train_loader, valid_loader, test_loader = get_blink_data(
        args.batch, args.batch, whole_train=True
    )
else:
    train_loader, valid_loader, test_loader = get_blink_data(
...
f = open(os.path.join(args.resultroot, f"TrainedBlink_log_{args.modelname}{args.topology}{args.resultsuffix}.txt"), "a")
